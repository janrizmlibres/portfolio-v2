...
export function StateTwoView({ chatPanelSlot, chatCollapsed }: Props) {
  ...
  const grid = chatCollapsed
    ? "grid gap-4 px-4 pb-16 pt-6 sm:px-8 lg:grid-cols-[minmax(0,1fr)_56px] lg:gap-4 lg:px-12 max-lg:pb-[35vh]"
    : "grid gap-4 px-4 pb-16 pt-6 sm:px-8 lg:grid-cols-[minmax(0,1fr)_380px] lg:gap-8 lg:px-12 max-lg:pb-[35vh]";
  return (
